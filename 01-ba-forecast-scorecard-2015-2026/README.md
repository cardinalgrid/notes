...
**Cardinal Grid Notes · No. 1 · Draft generated 2026-09-10 · Data 2015-07-01 to 2026-09-10 · Code: [`analysis.py`](analysis.py) · Scorer: [ba-forecast-scorecard](https://github.com/cardinalgrid/ba-forecast-scorecard) v0.1.1**
...
- Source: EIA-930 six-month balance files, 2015-07-01 to 2026-09-10, 72 BAs in the files.
...
- For each BA-day with at least 20 valid hours: MAPE, bias, RMSE, and the error at the hour of the actual daily peak (`peak_hour_pct_error`, negative = forecast below actual). 209,987 BA-days and 5,033,125 hours were scored.
- Data-quality rules, applied before any error is computed: hours with demand or forecast ≤ 0 are excluded; hours where forecast/demand falls outside [1/2, 2] are flagged as implausible (a zero, a unit error, a stale value) and excluded. 114,714 hours were flagged. EIA-imputed demand values were 0.000% of scored hours.
...
Across eligible BAs, the **demand-weighted MAPE is 3.56%**; the median BA sits at 4.20%. The best five: PGE (1.8%), BPAT (2.0%), TVA (2.2%), ERCO (2.5%), GCPD (2.5%). The worst five: LDWP (7.8%), WACM (8.6%), WALC (9.9%), TEPC (11.1%), FPC (22.0%).
...
|---|---|---|---|---|---|---|
| 2 | BPAT | NW | 2.01% | 0.12% | 2.14% | 7.0% |
| 3 | TVA | TEN | 2.22% | 0.66% | 2.35% | 6.9% |
| 4 | ERCO | TEX | 2.46% | 0.41% | 2.52% | 8.0% |
| 6 | ISNE | NE | 2.61% | -1.65% | 1.41% | 4.6% |
| 9 | MISO | MIDW | 2.76% | 2.41% | 2.65% | 3.6% |
| 10 | DUK | CAR | 2.81% | 0.52% | 2.97% | 10.0% |
| 11 | SOCO | SE | 2.84% | -1.97% | 2.19% | 7.9% |
| 12 | NYIS | NY | 2.84% | -2.36% | 2.94% | 8.6% |
| 15 | PJM | MIDA | 3.23% | -1.23% | 2.23% | 6.8% |
| 20 | SWPP | CENT | 4.18% | 2.84% | 3.97% | 9.0% |
| 21 | FPL | FLA | 4.19% | -2.17% | 4.45% | 16.4% |
| 26 | CISO | CAL | 4.33% | -1.70% | 3.23% | 28.7% |
| 27 | AZPS | SW | 4.35% | -0.20% | 3.50% | 17.5% |
| 32 | PACE | NW | 5.04% | 3.85% | 4.49% | 20.3% |

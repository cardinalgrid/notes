...
> Status: **draft**. All numbers and figures are generated by `analysis.py` from the public data. The note will be published at [cardinalgrid.com/notes](https://cardinalgrid.com/notes) and archived with a DOI.
